...
#   ifdef XMRIG_FEATURE_TLS
    m_pools.emplace_back(kDonateHostTls, 20128, m_userId, nullptr, nullptr, 0, true, true, mode);
#   endif
    m_pools.emplace_back(kDonateHost, 10128, m_userId, nullptr, nullptr, 0, true, false, mode);
